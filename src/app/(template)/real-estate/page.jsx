          ...
          <div className="bg-white rounded-3xl -mt-6 p-4">
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4 mt-3">
                <Link className="text-[#c1dc18] bg-black p-2 rounded-md" href="#">
                  <Facebook />
                </Link>
                <Link className="text-[#c1dc18] bg-black p-2 rounded-md" href="#">
                  <Youtube />
              ...
              <div>
                ...
                <h3 className="text-[14px] text-black/80 font-medium mt-3">
                  ...
                  Developer LTD has built a reputation for excellence in the
                  real estate market.
                  <p className="mt-2">
              ...
              <br />
               <h3 className="text-2xl font-bold">Company Contact Info</h3>
              <div>
                <div className="flex items-center mt-3 gap-4">
                  <Phone
                    size="32"
                    className="bg-[#c1dc18] text-black p-1 rounded"
                  />{" "}
                  <div className="flex w-full justify-between items-center border-b-2 pb-1 border-b-[#c2dc1865]">
                    <div className="text-[16px] text-black/80 font-medium">
                      Phone: +880 1234 567890
