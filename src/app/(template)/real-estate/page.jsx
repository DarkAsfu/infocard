...
const page = () => {
  useEffect(() => {
    ...
    if (!navigator.onLine && !window.__vcfDownloaded) {
        ...
        <div className='bg-[#1F1F21] rounded-b-3xl'>
          <div className='bg-white rounded-3xl -mt-6 p-4'>
            <div>
              ...
              <p className='text-[14px] text-black/80 font-medium mt-3'>
                Whether you're buying, selling, or renting, I provide
                personalized solutions to meet your unique needs. Let's turn
