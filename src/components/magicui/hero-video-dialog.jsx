      ...
      <button
        ...
        <div
          ...
          <div
            ...
            <div
              className={`relative flex size-20 scale-100 items-center justify-center rounded-full bg-red-400 shadow-md transition-all duration-200 ease-out group-hover:scale-[1.2]`}>
              <Play
        ...
        {isVideoOpen && (
          <motion.div
            ...
            <motion.div
              ...
              <motion.button
                className="absolute -top-16 right-0 rounded-full bg-[#cd1] p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
